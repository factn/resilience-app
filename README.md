...
| [src/App.jsx](https://github.com/factn/resilience-app/tree/master/src/App.js)                                     |                       This is the base file that sets up the routes and holds the default state of the application.                        |     Y |
