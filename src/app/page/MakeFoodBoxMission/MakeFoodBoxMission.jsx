...
function MakeFoodBoxMission({ history, firestore }) {
  ...
  function saveMissions(payload) {
    ...
    const model = { ...payload, ownerId: user.uid, type: "foodBox" };
...
export default withRouter(withFirestore(MakeFoodBoxMission));
