...
const DeliveryConfirmation = ({ deliveryImage, setStep }) => {
...
const FeedbackWithSuccess = ({ deliveryImage, handleChange, handleSubmit, values }) => {
  const classes = useStyles();
...
const Feedback = ({ deliveryImage, handleChange, handleSubmit, values }) => {
  const classes = useStyles();
