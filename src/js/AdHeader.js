...
export default class AdHeader extends Component {
	...
	changeActiveTabTo = tabName => {
		...
		if (tabName === "Donate")
			this.props.contextChange("donator");
		else if (tabName === "Do Work")
			this.props.contextChange("doer");
		else if (tabName === "Request Help")
			this.props.contextChange("requester");
		else if (tabName === "Verify Users")
			this.props.contextChange("verifier");
	}
